...
type PaymentConfirmationEmailSender struct {
}

func NewPaymentConfirmationEmailSender() EmailService {
	return &PaymentConfirmationEmailSender{}
}

func (p PaymentConfirmationEmailSender) SendEmail(v interface{}) error {
	paymentConfirmation := v.(domain.PaymentNotification)
	...
	tmpl, err := template.ParseFiles("payment_template.html")
	if err != nil {
